...
@section('content')
    <div class="hero" style="background-image: url('{{ asset('frontend/images/car-rent-image.webp') }}')">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-10">
                    <div class="row mb-5">
                        <div class="col-lg-7 intro">
                            <h1 class="text-white text-light"><strong>Sewa Mobil</strong> Mudah dan cepat.</h1>
                        </div>
                    </div>
