                ...
                <div class="col-lg-8">
                    ...
                    <div class="card p-5">
                        <form action="{{ route('car.store') }}" method="post">
                            ...
                            <div class="form-group">
                                <label for="nomer_wa">Nomor Hp/Whatsapp</label>
                                <input type="string" name="nomer_wa" value="{{ old('nomer_wa') }}" class="form-control"
                                    id="nomer_wa">
                            </div>
                            <div class="form-group row">
                                <label for="date_start" class="col-sm-2 col-form-label">Jadwal Pinjam</label>
                                <div class="col-sm-5">
                                    <input type="date" name="date_start" value="{{ date('Y-m-d') }}" class="form-control"
                                        id="date_start">
                                </div>
                                <label for="date_end" class="col-sm-2 col-form-label">Jadwal Kembali</label>
                                <div class="col-sm-3">
