...
Route::group(['middleware' => ['auth','is_admin'],'prefix' => 'admin','as' => 'admin.'],function () {
    ...
    Route::resource('bookings', \App\Http\Controllers\Admin\BookingController::class)->only(['index','edit', 'update', 'destroy', 'carReturn']);
    Route::resource('blogs', \App\Http\Controllers\Admin\BlogController::class);
});

Route::group(['middleware' => ['auth', 'is_user_rent'], 'prefix' => 'user_rent','as' => 'user_rent.'], function () {
    Route::resource('cars', \App\Http\Controllers\Admin\CarController::class);
    Route::resource('types', \App\Http\Controllers\Admin\TypeController::class);
    Route::resource('bookings', \App\Http\Controllers\Admin\BookingController::class)->only(['index']);
    Route::post('bookings/{booking}/car-return', [\App\Http\Controllers\Admin\BookingController::class, 'carReturn'])->name('bookings.car_return');
    Route::get('profile', [\App\Http\Controllers\ProfileController::class, 'show'])->name('profile.show');
    Route::put('profile', [\App\Http\Controllers\ProfileController::class, 'update'])->name('profile.update');
